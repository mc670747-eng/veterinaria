...
<head>
    ...
    <meta name="description" content="Sistema Veterinaria - Administrador">
    <meta name="author" content="">

    <title>@yield('titulo_pagina', 'Administración')</title>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Administrador Veterinaria {{ date('Y') }}</span>
                    </div>
                </div>
            </footer>
            {{-- End of Footer --}}
